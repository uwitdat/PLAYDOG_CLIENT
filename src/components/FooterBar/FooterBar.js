...
const FooterBar = () => {
    ...
    return (
        <div className='FooterBar'>
            ...
            <Link to='/dogs' style={linkStyle}><span onClick={() => setPath('/dogs')} className={path === '/dogs' ? 'FooterBar__icon active' : 'FooterBar__icon'}><FaPaw className={path === '/dogs' ? 'rotate' : null} /></span></Link>
